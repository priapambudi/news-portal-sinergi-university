...
function Mitra() {
  ...
  return (
    <div className="w-[85%] mx-auto my-10 py-10 md:py-[10px] md:px-[20px]">
      <h1 className="text-2xl font-bold">Mitra & Pers</h1>
      <p className="">Berita terkini mengenai mitra & pers kampus</p>
